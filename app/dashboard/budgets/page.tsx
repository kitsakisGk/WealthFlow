...
export default function BudgetsPage() {
  const budgets = [
    { id: 1, category: "Food & Dining", allocated: 800, spent: 520, period: "Monthly", color: "bg-positive" },
    { id: 2, category: "Transportation", allocated: 300, spent: 245, period: "Monthly", color: "bg-primary" },
    { id: 3, category: "Entertainment", allocated: 200, spent: 185, period: "Monthly", color: "bg-neutral" },
    { id: 4, category: "Shopping", allocated: 400, spent: 450, period: "Monthly", color: "bg-negative" },
    { id: 5, category: "Utilities", allocated: 250, spent: 120, period: "Monthly", color: "bg-positive" },
  ];
            ...
            <div key={budget.id} className="bg-white rounded-lg shadow p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-neutral-light">{budget.period}</p>
                </div>
