    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-neutral dark:text-gray-200">Add Funds</h2>
          <button
            onClick={onClose}
        ...
        <p className="text-sm text-neutral-light dark:text-gray-400 mb-4">
          Adding funds to: <span className="font-semibold text-neutral dark:text-gray-200">{goalName}</span>
        </p>
